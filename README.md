...
> **Note**: If you use a mixture of steroids, you will append the duration to the existing `steroid_planet:tech_fitness` effect if you already have the effect and select the better level between the existing effect and the new effect.
